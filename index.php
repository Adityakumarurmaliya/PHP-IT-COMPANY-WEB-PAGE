...
<head>
    ...
    <meta name="Description" content="s tech pvt ltd, an emerging software development company, located in Noida. Specializes in providing web-app development and digital marketing services.">
    <meta name="Keywords" content="software development company, app development company,Software Development Company in Noida, web development, web designing, digital marketing company.">
    <meta property="og:url" content="https://www.xyz.com/" />
    <meta property="og:site_name" content="s tech pvt ltd, an emerging software development company, located in Noida.         Specializes in providing web-app development and digital marketing services." />
    <meta property="article:publisher" content="https://www.facebook.com/xyz/" />
    <meta property="article:modified_time" content="2023-02-10T05:05:49+00:00" />

    <!-- Title  -->
    <title>Software Development Company in Noida | s tech pvt ltd</title>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="info">
                            <div class="section-head mb-60">
                                <h6 class="color-main text-uppercase">spiraleinfosoft</h6>
                                <h2>
                                    Technology & IT <span class="fw-normal">Solutions</span>
                                </h2>
                            </div>
                            <div class="text">
                                <h2>Let's build together a future of innovations and technology </h2>
                            </div>
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="img">
                            <img src="assets/img/react/banner.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="content">
                    ...
                    <div class="about-info">
                        <div class="row justify-content-between">
                            <div class="col-lg-5">
                                <div class="title">
                                    <h3 class=" wow fadeInUp slow">“Most trusted software development company”</h3>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="info">
                                    <h6 class=" wow fadeInUp slow">
                                        s tech pvt ltd is the most trusted and reliable Software Development Company in Delhi NCR.
                                        Our years of experience and the best team of experts and developers, enables us to offer some of the finest and prime services to our clients.
                                        The team of experts and developers is highly experienced and well certified.
                                        Till date, we have catered to a good number of happy and satisfied clients, by meeting all their requirements and expectations.
                                        <a href="about.php" class="btn btn-outline-light mt-5 sm-butn wow fadeInUp slow">
                        ...
                        <div class="info">
                            ...
                            <ul>
                                <li class="wow fadeInUp">
                                    ...
                                    <h6>
                                        We have developed 50+ websites and 25+ android and ios app.
                                    </h6>
                                </li>
                                <li class="wow fadeInUp">
                                    <span class="icon">
                                    ...
                                    <h6>
                                        <a href="">Need Help?</a>
                                        We will help you regarding your query.
                                    </h6>
                                </li>
                                <li class="wow fadeInUp">
                                    <span class="icon">
                            ...
                            <a href="about.php" class="btn butn-gard border-0 text-white wow fadeInUp">
            ...
            <div class="container">
                <div class="section-head mb-60 text-center">
                    ...
                    <h2 class="wow fadeInUp text-white">
                        Let's Send Us <span class="fw-normal">a Message Below</span>
                    </h2>
                </div>
                <div class="content">
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="contact_info text-white">
                                <p class="wow fadeInUp">We will help you regarding your query.</p>
                                <h4 class="wow fadeInUp"> Contact: +911202555999</h4>
                                <ul>
                                    <li class="wow fadeInUp">
                                        <strong>Address : </strong> 3rd floor Bhavani Complex, Sector-27 Atta,Near Sector- 18,metro station Noida-201301 UttarPradesh
                                    </li>
                                    <li class="wow fadeInUp">
                                        <strong>Email : </strong> info@xyz.com
                                    </li>
                                    <li class="wow fadeInUp">
                                        <strong>Work Hour : </strong> Mon - Fri: 10:00 - 18:30
                                    </li>
                                </ul>
...
<!-- Mirrored from iteck-html.themescamp.com/home-digital-agency.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 May 2023 06:12:37 GMT -->
